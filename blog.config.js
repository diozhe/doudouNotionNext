...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '糖🍬豆', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '糖🍬豆一个币圈交易者🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.cwz87.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '币圈, 交易，策略', // 网站关键词 英文逗号隔开
